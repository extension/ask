  ...
  def update_response
    ...
    if @response.update_attributes(params[:response])
      ...
      if params[:notify_submitter].present? && params[:notify_submitter] == '1'
        #Notification.create(notifiable: response, created_by: initiated_by.id, recipient_id: question.submitter.id, notification_type: Notification::AAE_EXPERT_RESPONSE_EDIT_TO_SUBMITTER, delivery_time: 1.minute.from_now)
      end
