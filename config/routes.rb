...
Aae::Application.routes.draw do
  ...
  namespace :expert do
    ...
    match "reports/locations_and_groups", to: "reports#temporary_reports_page", :via => [:get], :as => 'reports_locations_and_groups'
  ...
  match "view/:fingerprint" => "questions#submitter_view", :requirements => { :fingerprint => /[[:xdigit:]]+/ }, :via => [:get, :post], :as => 'submitter_view'
